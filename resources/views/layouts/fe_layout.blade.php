...
<body class="d-flex flex-column min-vh-100">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('homepage') ? 'active' : '' }}"
                           href="{{ route('homepage') }}">Início</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('estudios.*') ? 'active' : '' }}"
                           href="{{ route('estudios.list') }}">Estúdios</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('filmes.*') ? 'active' : '' }}"
                           href="{{ route('filmes.list') }}">Filmes</a>
                    </li>
                </ul>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow-sm" aria-labelledby="userDropdown">
                                    <li>
                                        <a class="dropdown-item d-flex align-items-center gap-2" href="{{ route('perfil.show') }}">
                                            <i class="bi bi-person text-secondary"></i> O meu Perfil
                                        </a>
                                    </li>
    ...
    {{-- Bootstrap JS apenas para dropdowns e collapse da navbar --}}
