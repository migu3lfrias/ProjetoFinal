            ...
            <div class="col-6 col-md-3">
                <div class="card film-card h-100">
                    <div class="film-poster-wrap">
                        <img src="{{ $filme->capa }}"
                            onerror="this.onerror=null;this.src='{{ $filme->capa ? asset('storage/' . $filme->capa) : '' }}';this.onerror=function(){this.src='https://placehold.co/400x600/292b2c/FFFFFF?text={{ urlencode($filme->titulo) }}';};"
                            class="card-img-top"
